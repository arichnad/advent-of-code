...
# add=0
# for line in zip(sorted([data[0] for data in data]), sorted([data[1] for data in data])):
# 	add+=abs(line[1]-line[0])
# print(add)
add=0
for line in sorted([data[0] for data in data]):
	for line2 in sorted([data[1] for data in data]):
		if line==line2:
			add+=line
print(add)
