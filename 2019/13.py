...
#         print('oops')
#         break
#         # print('### input: data[', a, '] = board[', y, x, '] = ', b)
#         # data[a]=b
#         # pc += 2
#     elif code==4:
#         # print('### output', a)
...
#         print('oops')
#         break
# for line in board: print(''.join([str(i) for i in line]))
# print(sum(sum(1 if col==2 else 0 for col in line) for line in board))
